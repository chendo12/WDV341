...
<p>
	...
	<br><br>
	We have you listed as an <b><?php if(isset($_POST['academic_standing'])){echo $_POST['academic_standing'];}?></b> academic standing starting this fall.
	<br><br>
	You have declared <b><?php if(isset($_POST['program'])){echo $_POST['program'];}?></b> as your major. 
	Based upon your responses we will provide the following information in our confirmation email to you at <b><?php echo $_POST['email'];?></b>.
	<br>
<p>
	<?php 
	if(isset($_POST['program_adv'])){echo $_POST['program_adv'];}?>
</P>
<p>
	<?php
	if(isset($_POST['program_info'])){echo $_POST['program_info'];}?>
	<br><br>
